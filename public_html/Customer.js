...
// Model for Customer entity
    models.Customer = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/ServicioRESTUdeA/webresources/customer/",
        ...
        sync: function (method, model, options) {
            ...
            if (method === 'create') {
                options.url = 'http://localhost:8080/ServicioRESTUdeA/webresources/customer/';
            }
    ...
    models.CustomerCollection = Backbone.Collection.extend({
        ...
        url: "http://localhost:8080/ServicioRESTUdeA/webresources/customer/",
        sync: function (method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function (jqXHR, textStatus, errorThrown) {
